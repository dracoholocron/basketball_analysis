...
class BallAquisitionDetector:
    ...
    def __init__(
        ...
        self.containment_threshold = (
            ...
            else settings.containment_threshold
        )
    ...
    def find_best_candidate_for_possession(self, ball_center, player_tracks_frame, ball_bbox):
        ...
        # First priority: players with high containment — pick the one closest to ball
        if high_containment_players:
            best_candidate = min(high_containment_players, key=lambda x: x[1])
